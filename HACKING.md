...
You need Python 3, podman or docker, and GNU make installed on your system to get started.
...
| --- | --- | --- |
| `VERSION` | The version of the collection and EE to package/use | 0.4.2 |
